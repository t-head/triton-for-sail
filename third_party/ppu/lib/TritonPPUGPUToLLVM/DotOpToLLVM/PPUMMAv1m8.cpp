...
inline static const std::map<TensorCoreType, std::string> mmaInstrTix = {
    ...
    {TensorCoreType::FP32_FP32_FP32_FP32,
     "ppu.mma.sync.aligned.m8n16k8.row.col.f32.f32.f32.f32"},
    ...
    {TensorCoreType::FP32_FP8E5M2_FP8E4M3FN_FP32,
     "ppu.mma.sync.aligned.m16n8k32.row.col.f32.e5m2.e4m3.f32"},
    {TensorCoreType::FP32_FP8E4M3FN_FP8E5M2_FP32,
     "ppu.mma.sync.aligned.m16n8k32.row.col.f32.e4m3.e5m2.f32"},
