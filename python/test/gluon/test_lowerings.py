...
from triton._internal_testing import is_blackwell, is_cuda, is_hip, is_ppu, is_hopper_or_newer, get_hip_lds_size
...
@pytest.mark.skipif(is_cuda() or is_ppu(), reason="PartitionedSharedLayout is not supported on CUDA or PPU")
