...
from triton._internal_testing import is_blackwell, is_hopper_or_newer, is_cuda, is_ppu, is_hip_cdna4, is_hip_gfx1250, is_hip_cdna3_or_newer
...
@pytest.mark.skipif(not (is_cuda() or is_ppu()), reason="Requires CUDA or PPU")
